...
<body onload="time()" class="app sidebar-mini rtl">
  ...
  <aside class="app-sidebar">
    <div class="app-sidebar__user"><img class="app-sidebar__user-avatar" src="img/â.jpg"
        alt="User Image">
      <div>
    ...
    <hr>
    <ul class="app-menu">
      <li><a class="app-menu__item " href="crud_nhan_vien/table-nhan-vien.php"><i class='app-menu__icon bx bx-id-card'></i> <span
  ...
  <main class="app-content">
    ...
    <div class="text-center" style="font-size: 13px">
      <p><b>Copyright
          ...
          </script> Phần mềm quản lý bán hàng | Dev New NiKe
        </b></p>
    </div>
  </main>

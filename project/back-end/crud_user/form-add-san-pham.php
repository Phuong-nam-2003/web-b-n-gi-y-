...
if (isset($_POST['submit'])) {
    ...
    if (empty($name)) {
        ...
        if (empty($error)) {
            ...
            $sql_insert = "INSERT INTO category(name, avatar, gia, soluong) VALUES ('$name','$filename','$gia','$soluong')";
                    ...
                    <form class="row" action="" method="post" enctype="multipart/form-data">
                        ...
                        <div class="form-group  col-md-3">
                            ...
                            <input class="form-control" type="number" name="soluong">
                              ...
                              <a class="btn btn-cancel" href="table-data-quanly-sanpham.php">Hủy bỏ</a>
                    </form>
                </div>
            </div>
        </div>

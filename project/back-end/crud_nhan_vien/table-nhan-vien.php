...
$users = mysqli_fetch_all($resut_all, MYSQLI_ASSOC);
...
<body onload="time()" class="app sidebar-mini rtl">
  ...
  <aside class="app-sidebar">
    ...
    <ul class="app-menu">
      ...
      <li><a class="app-menu__item active" href="form-tao-nhan-vien.php"><i class='app-menu__icon bx bx-id-card'></i>
          ...
          <div class="tile-body">
            ...
            <div class="row element-button">
              <div class="col-sm-2">
                ...
                <a class="btn btn-add btn-sm" href="form-tao-nhan-vien.php" title="Thêm"><i class="fas fa-plus"></i>
                  Tạo mới nhân viên</a>
              </div>
